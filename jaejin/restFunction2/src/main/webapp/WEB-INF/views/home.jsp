...
<body>
	...
	<div id="login_form">
		<div class="signUp" id="signupForm">
			...
			<input type="text" class="signUpInput" placeholder="이메일"
				name="userEmail" id="loginUserEmail" autofocus required> <input
				type="password" class="signUpInput" placeholder="비밀번호"
				name="userPassword" id="loginUserPassword" required>
	...
	<div id="register_form">
		<div class="signUp" id="signupForm">
			...
			<input type="text" class="signUpInput" name="userName" id="registerUserName"
				placeholder="이름" autofocus required> <input type="text"
				class="signUpInput" name="userEmail" id="registerUserEmail" placeholder="이메일" required>
			<input type="password" class="signUpInput" name="userPassword" id="registerUserPassword"
