...
<link
	href="<%=request.getContextPath()%>/resources/css/full-width-pics.css"
	rel="stylesheet">
...
<body>
	...
	<header class="py-5 bg-image-full"
		style="background-image: url('<%=request.getContextPath()%>/resources/img/main.png'); min-height: 388px">
		<div id=test>
			<img class="img-fluid d-block mx-auto"
				src="<%=request.getContextPath()%>/resources/img/logo.png" alt="">
		</div>
		<!-- <div class="py-5"></div> -->
	</header>
