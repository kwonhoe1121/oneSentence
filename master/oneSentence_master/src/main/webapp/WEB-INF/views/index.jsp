...
<link href="https://fonts.googleapis.com/css?family=Noto+Serif+KR"
	rel="stylesheet">
<link
	href="https://fonts.googleapis.com/css?family=Do+Hyeon|Noto+Serif+KR"
	rel="stylesheet">
<!-- Bootstrap core CSS -->
<link
...
<body>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/userpage/${User.userIdx}"><button
									class="btn btn-primary navbar-btn hbtn">마이페이지</button></a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<header class="py-5 bg-image-full"
		style="background-image: url('${pageContext.request.contextPath}/resources/naeun/user/img/6.jpg'); min-height: 388px;">
		<div id="test"
			style="color: white; text-align: center; font-size: 4rem; padding-top: 3rem">
