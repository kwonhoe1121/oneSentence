...
<div class="container">
	...
	<h2 class="h2" style="font-size: 1.5rem;">
			<strong>한문장 검색결과</strong><a href="${pageContext.request.contextPath}/search/searchMoreSentenceList?query=${param.query}"><span class="more" style="font-size: 1rem;"><strong>더보기</strong></span></a>
		</h2>
