...
<body>
	...
	<c:forEach items="${items}" var="items">
		<header class="bg-white">
			<img src="${items.cover}" width="100%" height="300rem"
				style="filter: blur(2px)">

			<div id="d2" class="container">

				<img id="photo" src="${items.cover}" width="150rem" height="200rem">
				<div id="d" class="bg-white">
					...
					<ul>
						...
						<li><a
							href="${pageContext.request.contextPath}/onesentence/playlist/contents/${items.isbn}">한문장
								듣기</a></li>
						<hr>
						<li>
							<form
								action="${pageContext.request.contextPath}/onesentence/insertForm"
								method="POST">
								<input type="text" name="isbn" value="${items.isbn}"
									hidden="true"> <input type="text" name="author"
									value="${items.author}" hidden="true"> <input
									type="text" name="publisher" value="${items.publisher}"
									hidden="true"> <input type="text" name="bookTitle"
									value="${items.title}" hidden="true"> <input
									type="text" name="bookGenre" value="${items.categoryName}"
									hidden="true">
